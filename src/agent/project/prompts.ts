  ...
  return [
    {
      ...
      content: [
        ...
        "If the latest observation tool is loop_rescue, follow its rescue-attempt wording exactly. Do not repeat the previous action; make one focused repair from retained evidence, finish if already complete, or return a blocker answer.",
      ...
      content: JSON.stringify(
        {
          ...
          instructions: [
            ...
            "When the latest observation has tool loop_rescue, change strategy immediately, follow its rescue-attempt wording, and do not repeat the previous failing action.",
